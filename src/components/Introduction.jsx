...
const HeroIntro = () => {
  return (
    <section
      className="relative w-full h-[100vh] bg-cover bg-center flex items-center justify-center md:justify-start" 
      style={{
        backgroundImage:
    ...
    >
      <div className="relative z-10 bg-black/60 backdrop-blur-sm text-white w-full max-w-xl px-6 md:px-12 py-8 rounded-lg mx-4 md:ml-16 md:mx-0"> 
